...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('forecast riddle');
      cy.get(`[data-cy="title"]`).should('have.value', 'forecast riddle');

      cy.get(`[data-cy="description"]`).type('uh-huh unexpectedly officially');
      cy.get(`[data-cy="description"]`).should('have.value', 'uh-huh unexpectedly officially');
