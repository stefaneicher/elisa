...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('out');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'out');

      cy.get(`[data-cy="postalCode"]`).type('roughly successfully');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'roughly successfully');

      cy.get(`[data-cy="city"]`).type('South Johathanbury');
      cy.get(`[data-cy="city"]`).should('have.value', 'South Johathanbury');

      cy.get(`[data-cy="stateProvince"]`).type('emphasise because');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'emphasise because');
