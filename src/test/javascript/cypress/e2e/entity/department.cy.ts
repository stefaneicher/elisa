...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'and unimpressively' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('growling terribly excited');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'growling terribly excited');
