...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('International Security Executive');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'International Security Executive');

      cy.get(`[data-cy="minSalary"]`).type('25030');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '25030');

      cy.get(`[data-cy="maxSalary"]`).type('3905');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '3905');
