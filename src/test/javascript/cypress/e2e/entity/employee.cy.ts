...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Santiago');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Santiago');

      cy.get(`[data-cy="lastName"]`).type('Bradtke');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Bradtke');

      cy.get(`[data-cy="email"]`).type('Charlotte.Keebler@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Charlotte.Keebler@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('failing');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'failing');

      cy.get(`[data-cy="hireDate"]`).type('2024-01-21T23:27');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-01-21T23:27');

      cy.get(`[data-cy="salary"]`).type('2977');
      cy.get(`[data-cy="salary"]`).should('have.value', '2977');

      cy.get(`[data-cy="commissionPct"]`).type('23621');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '23621');
