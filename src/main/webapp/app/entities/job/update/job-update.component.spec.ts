...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 21341 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 18861 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 2804 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 15598 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 3948 };
      job.tasks = [task];
      const employee: IEmployee = { id: 21731 };
      job.employee = employee;
