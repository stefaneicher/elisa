...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 3489 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 19518 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 6887 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 26878 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 25430 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 26392 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 27451 };
      jobHistory.job = job;
      const department: IDepartment = { id: 25289 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 6969 };
      jobHistory.employee = employee;
